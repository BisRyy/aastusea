  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Welcome to{" "}
          <span className="font-bold tracking-tighter">AASTUSEA</span>
        </motion.h1>
        <motion.p
          className="max-w-md text-accent-foreground/80 transition-colors sm:text-lg"
          variants={STAGGER_CHILD_VARIANTS}
        >
          AASTUSEA is a platform for software engineers to connect, learn, and
          grow. Complete simple onboarding steps to get started.
        </motion.p>
        <motion.div
          variants={STAGGER_CHILD_VARIANTS}
        ...
        >
          <Button className="px-10 font-medium text-base" onClick={next}>
            Get Started
          </Button>
        </motion.div>
      </motion.div>
