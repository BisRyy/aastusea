...
const MembershipItem = ({ featureTab }: { featureTab: FeatureTab }) => {
  ...
  return (
    <div className="flex flex-row md:flex-col items-center gap-8 lg:gap-19">
      <div className="md:w-1/2">
        <h2 className="mb-7 text-2xl font-bold xl:text-4xl">{title}</h2>
        <p className="mb-5">{desc1}</p>
        <p className="w-11/12">{desc2}</p>
      </div>
      <div className="relative mx-auto aspect-[562/366] max-w-[550px] md:block md:w-1/2 rounded-lg overflow-hidden">
