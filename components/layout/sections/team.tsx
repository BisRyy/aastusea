...
export const TeamSection = () => {
  const teamList: TeamProps[] = [
    {
      imageUrl: "https://i.pravatar.cc/250?img=57",
      firstName: "Bisrat",
      lastName: "Kebere",
      positions: [
        "Software Developer",
      ...
      socialNetworks: [
        ...
        {
          name: "LinkedIn",
          url: "https://www.linkedin.com/in/bisry/",
        },
        {
          name: "Github",
          url: "https://github.com/BisRyy",
        },
        {
          name: "X",
          url: "https://x.com/BisRyyy",
        },
      ],
    },
    {
    ...
    <section id="team" className="container lg:w-[75%] py-24 sm:py-32">
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl md:text-4xl text-center font-bold">
          Meet The Team Who Started It All 🚀
        </h2>
      </div>
            ...
            >
              <CardHeader className="p-0 gap-0">
                ...
                <CardTitle className="py-6 pb-4 px-6">
                  <span className="text-primary mr-2">{firstName}</span>
                  {lastName}
                </CardTitle>
              </CardHeader>
